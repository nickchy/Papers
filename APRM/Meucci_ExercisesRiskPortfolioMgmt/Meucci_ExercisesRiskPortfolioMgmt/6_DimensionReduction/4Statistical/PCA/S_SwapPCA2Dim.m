...
h=plot([2 4],Current_Curve);
hold on 
h=plot([2 4],Current_Curve'+F_std(2)*EigVecs(:,2)+F_std(1)*EigVecs(:,1),'r');
hold on 
h=plot([2 4],Current_Curve'-F_std(2)*EigVecs(:,2)-F_std(1)*EigVecs(:,1),'g');
legend('base','+1 sd of both fact','-1 sd of both fact')
xlabel('Time to maturity, years')
